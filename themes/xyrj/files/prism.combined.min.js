/* PrismJS 1.30.0
https://prismjs.com/download.html?utm_source=chatgpt.com#themes=prism-dark&languages=markup+css+clike+javascript+c+csharp+cpp+java+javadoclike+js-extras+json+json5+jsonp+jsstacktrace+js-templates+markdown+markup-templating+nginx+php+phpdoc+php-extras+plsql+python+sql+wiki+xml-doc&plugins=line-numbers+show-invisibles+autolinker+wpd+custom-class+file-highlight+show-language+jsonp-highlight+highlight-keywords+remove-initial-line-feed+inline-color+keep-markup+command-line+unescaped-markup+normalize-whitespace+data-uri-highlight+toolbar+copy-to-clipboard+download-button+match-braces+diff-highlight+filter-highlight-all+treeview */
